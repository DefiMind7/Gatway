...
/**
 * Aqui não há endpoint público.
 *
 * A candidatura morava neste arquivo, aberta a qualquer um. Ela mudou de lugar
 * para `/loja/api/application`, atrás do login: sem conta não havia para onde
 * mandar a resposta da análise, e "a resposta vai por e-mail" era uma promessa
 * que o sistema não tinha como cumprir.
 */
